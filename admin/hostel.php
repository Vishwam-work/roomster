...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="https://roomsterinc.000webhostapp.com/index.php"><img class="logo" src="images/logoing-removebg-preview.png" alt=""></a>
...
$sql = "SELECT * FROM hostel where ownerid='vj941'";
...
while($row = mysqli_fetch_array($result)) { ?>
     <tr>
        ...
        <td>
           <a class='btn btn-primary btn-sm' href="accept.php">Accept</a> 
              <a id="decline" class='btn btn-danger btn-sm' href="decline.php">Decline</a> 
        </td>
    </tr>
